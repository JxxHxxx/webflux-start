...
import com.example.webfluxstart.reference_book.operators.error.domain.NotAllowedException;
import com.example.webfluxstart.reference_book.operators.error.domain.Topic;
import lombok.extern.slf4j.Slf4j;
import reactor.core.publisher.Flux;

import java.util.List;

import static com.example.webfluxstart.reference_book.operators.error.domain.Topic.*;
